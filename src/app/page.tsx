...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center p-8 sm:p-20 bg-white text-foreground selection:bg-neon-purple selection:text-white overflow-x-hidden relative">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-red-700">
                      <p>
                        We are serving offline results because the <strong>Mistral API Key</strong> is missing.
                      </p>
                      <p className="mt-1">
                        Please check your <code>.env.local</code> file and ensure <code>MISTRAL_API_KEY</code> is set correctly.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <footer className="absolute bottom-4 left-0 w-full text-center text-zinc-400 text-xs font-mono pointer-events-none">
